...
## Python
### VENV
- Store virtual environments in `~`: `mkdir ~/venv`
...
- Source the assignments' virtual environment: `. ~/venv/homework1`
...
- Update requirements files for the sourced venv using pip: `pip freeze > <assignment>/requirements.txt`
- Install the dependencies for the target assignment: `pip install -r homework1/requirements.txt`
...
## Tests
- Individual tests: `pytest homework1/tests/test_task1.py`
- All tests for an assignment: `pytest homework1`
- All tests: `pytest`